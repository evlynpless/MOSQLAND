...
#SBATCH -n 1 -c 16 -N 1
#SBATCH -t 24:00:00 
#SBATCH -o /gpfs/scratch60/fas/powell/esp38/stdout/grass_r_rfsrc_allPoints.sh.%A_%a.out
#SBATCH -e /gpfs/scratch60/fas/powell/esp38/stderr/grass_r_rfsrc_allPoints.sh.%A_%a.err
...
#come back
#echo "index,V1,V2,locality1,locality2,lat1,long1,lat2,long2,FST_lin,CSE,Resd" > ${OUT_TXT}/EAfr_FST_list.csv
#awk -v point=$point  -F ","  '{ if ($2==point || $3==point ) print }' $IN_TXT/EAfr_FST_list.csv  >> ${OUT_TXT}_${point}/FST_list_NAmRF3_Test$point.csv
#awk -v point=$point  -F ","  '{ if ($2!=point && $3!=point ) print }' $IN_TXT/EAfr_FST_list.csv  > ${OUT_TXT}_${point}/FST_list_NAmRF3_Trai$point.csv

awk -v point=$point  -F ","  '{ if ( 1 > 0 ) print }' $IN_TXT/EAfr_FST_list.csv  > ${OUT_TXT}/EAfr_FST_list.csv 
