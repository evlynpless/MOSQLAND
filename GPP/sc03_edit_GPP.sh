...
#gdal_edit.py -a_ullr -180   84  180  -90 GPP.VPM.mean.M${n}.v20.CMG_res.tif                                                                                                                  
#gdal_edit.py -a_nodata -999 GPP.VPM.mean.M${n}.v20.CMG.tif                     
                                                                                        
#pksetmask -i GPP.VPM.mean.M${n}.v20.CMG.tif  -m GPP.VPM.mean.M${n}.v20.CMG.tif  -o GPP.VPM.mean.M${n}.v20.CMG.tif --msknodata -999 -nodata -9999                                                                   
