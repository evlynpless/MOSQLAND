...
#SBATCH -e /gpfs/scratch60/fas/powell/esp38/stderr/sc01_grass_r_rfsrc_allPoints.sh.%A_%a.err
...
awk -v point=$point  -F ","  '{ if ( 1 > 0 ) print }' $IN_TXT/FST_list_NAmRF4_reduced.csv  > ${OUT_TXT}/FST_list_NAmRF3_all.csv 
