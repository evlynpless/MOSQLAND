...
#SBATCH -n 1 -c 1  -N 1                                  
#SBATCH -t 10:00:00                                      
#SBATCH -o /gpfs/scratch60/fas/powell/esp38/stdout/sc05_iterativeRF_Florida.sh.%J.out  
#SBATCH -e /gpfs/scratch60/fas/powell/esp38/stdout/sc05_iterativeRF_Florida.sh.%J.err  
