...
save.image(file = "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/sc05D_sc06D_rasterstack_image.RData")
...
save.image(file = "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/sc05D_sc06D.RData")
