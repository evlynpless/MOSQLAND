...
#samplesize  <- Sys.getenv(c('samplesize')) #add multiple runs later
...
write.table(Straight_rsq, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_RSQ_Table.txt", row.names =FALSE, col.names=FALSE)
...
write.table(Straight_mse, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_MSE_Table.txt", row.names =FALSE, col.names=FALSE)
...
write.table(Straight_mse2, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_MSE2_Table.txt", row.names =FALSE, col.names=FALSE)
...
write.table(cor1, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_InternalValidation.txt", row.names =FALSE, col.names=FALSE)
write.table(cor2, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_ExternalValidation.txt", row.names =FALSE, col.names=FALSE)
...
write.table(LCP_rsq, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_RSQ_Table.txt", append=TRUE, row.names =FALSE, col.names=FALSE)
...
write.table(LCP_mse, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_MSE_Table.txt", append=TRUE, row.names =FALSE, col.names=FALSE)
...
write.table(LCP_mse_fromEquation, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_MSE_fromEquation_Table.txt", append=TRUE, row.names =FALSE, col.names=FALSE)
...
write.table(cor1, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_InternalValidation.txt", append=TRUE, row.names =FALSE, col.names=FALSE)
write.table(cor2, "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12_ExternalValidation.txt", append=TRUE, row.names =FALSE, col.names=FALSE)
...
save.image(file = "/project/fas/powell/esp38/dataproces/MOSQLAND/consland/RF/NAm_RF_3/sc12.RData")
