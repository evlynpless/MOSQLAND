...
gdalwarp -r bilinear -tr 0.00833333333333333 -0.00833333333333333  -te -180 -60 180 90  ABS50_BK.tif ABS50_res.tif -co COMPRESS=DEFLATE -co ZLEVEL=9 -overwrite
...
gdal_translate  -projwin -85 31.5 -79.8 24.0  ABS50_res.tif  $OUTDIR/ABS50S_res_FloridaClip.tif -co COMPRESS=DEFLATE-co ZLEVEL=9               
